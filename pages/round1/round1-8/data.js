function getData() {
  return [
    ...
    { "id": "1-2", "position": "1-2", "class": "", "attribute": "", "arrived": "false" },
    ...
    { "id": "5-4", "position": "5-4", "class": "arrived", "attribute": "start", "arrived": "false" }]
}
function getStart() {
  return 4 * 4 + 3
}
function getSelfUrl() {
  return '/pages/round1/round1-8/round1-8'
}
function getNextUrl() {
  return '/pages/round1/round1-9/round1-9'
}
